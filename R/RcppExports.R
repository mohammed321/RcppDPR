...
run_VB_no_kinship <- function(y, W, X, n_k = 4L, l_min = 1e-7, l_max = 1e5, n_region = 10L) {
    .Call(`_RcppDPR_run_VB_no_kinship`, y, W, X, n_k, l_min, l_max, n_region)
}
...
run_gibbs_without_u_screen_no_kinship <- function(y, W, X, n_k = 4L, w_step = 1000L, s_step = 1000L, l_min = 1e-7, l_max = 1e5, n_region = 10L) {
    .Call(`_RcppDPR_run_gibbs_without_u_screen_no_kinship`, y, W, X, n_k, w_step, s_step, l_min, l_max, n_region)
}
...
run_gibbs_without_u_screen_adaptive_no_kinship <- function(y, W, X, m_n_k = 6L, w_step = 1000L, s_step = 1000L, l_min = 1e-7, l_max = 1e5, n_region = 10L) {
    .Call(`_RcppDPR_run_gibbs_without_u_screen_adaptive_no_kinship`, y, W, X, m_n_k, w_step, s_step, l_min, l_max, n_region)
}
